...
<body>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="contact.html" class="btn btn-primary rounded-pill py-2 px-4">Get Started</a>
                </div>
            </nav>
        </div>
    </div>
    ...
    <?php
    // Get the pickup date from the URL
    $pickup_date = isset($_GET['pickup_date']) ;
    ?>
    <div class="container-2">

        <i class="bi bi-check-circle"></i>
        <h1>Thank you for your reservation!</h1>
        <p>The order confirmation email with details of your order and a link to track its progress has been sent to
